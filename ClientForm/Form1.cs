    ...
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            client.BeginLogin(ar =>
            {
                ...
                if (a.BaseResult == baseResult.Successful)
                    client.BeginConnectOMCS(iar => { showResult((IResult)iar); Invoke(new Action(() => { label3.Text = "id:0000"; })); }, "127.0.0.1", 9900);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            client.BeginLogin(ar =>
            {
                var a = (NCAsyncResult)ar;
                if (a.BaseResult == baseResult.Successful)
                    client.BeginConnectOMCS(iar => { showResult((IResult)iar); Invoke(new Action(() => { label3.Text = "id:1501"; })); }, "127.0.0.1", 9900);
            }
            , "1501", "123", null);
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            client.BeginLogin(ar =>
            {
                var a = (NCAsyncResult)ar;
                if (a.BaseResult == baseResult.Successful)
                    client.BeginConnectOMCS(iar => { showResult((IResult)iar); Invoke(new Action(() => { label3.Text = "id:1502"; })); }, "127.0.0.1", 9900);
            }
            , "1502", "123", null);
        }
